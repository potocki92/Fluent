...
/**
 * Fetch the standalone placement-test item bank. `correct_idx` is never selected
 * here — the answer key stays server-side in the `grade-calibration` Server
 * Action. Item selection only needs `difficulty`.
 */
