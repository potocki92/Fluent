 ...
 * that were actually created. There is deliberately no "analiza rozdziału" and
 * no comprehension score — nothing here knows whether the chapter was
 * understood, and a summary that implied otherwise would be the reader claiming
 * knowledge it never measured.
 */
